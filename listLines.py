# Dahililerin listelenmesi / Listing lines
# Adem ÖZİPEK
...
search_criteria = {
    #'pattern':'123%'
    'description':'A%' #Sondaki % işareti ile A harfiyle başlayan sonuçları filtreliyoruz. / % for starts with
}

#Sonuçlarda gösterilecek alanlar / Returned tags
returned_tags = {
    'pattern' : '%', #Line numarası / Line number
    'description' : '%'
}
...
#listLine AXL metodunu çalıştırarak sorgulama yapıyoruz / Executing listLine AXL method
response = service.listLine(searchCriteria=search_criteria, returnedTags=returned_tags)
